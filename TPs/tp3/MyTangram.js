...
export class MyTangram extends CGFobject {
    ...
    // Enable or Disable normals display
    ...
    display() {
        ...
        this.scene.pushMatrix();
        this.materials.smallTriangle1.apply();
        this.scene.translate(0, -1, 0);
        this.s1.display();
        this.scene.popMatrix();

        this.scene.pushMatrix();
        this.materials.smallTriangle2.apply();
        ...
        this.scene.pushMatrix();
        this.materials.bigTriangle1.apply();
        ...
        this.scene.pushMatrix();
        this.materials.bigTriangle2.apply();
